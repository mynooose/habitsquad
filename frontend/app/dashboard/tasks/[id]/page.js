      ...
      {showDelete && (
        <div className="mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/20">
          ...
          <div className="flex gap-3">
            <button onClick={() => setShowDelete(false)} className="flex-1 py-2 rounded-lg bg-surface-100 text-sm font-medium hover:bg-surface-200">Cancel</button>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            <button type="button" onClick={() => setGroupId(null)}
              className={cn('px-3 py-2 rounded-lg text-sm font-medium transition-colors', groupId === null ? 'bg-white/10 text-white ring-1 ring-white/20' : 'bg-surface-100 text-zinc-400 hover:text-white')}>
              Personal
            </button>
            {groups.map(g => (
              <button key={g.id} type="button" onClick={() => setGroupId(g.id)}
                className={cn('px-3 py-2 rounded-lg text-sm font-medium transition-colors', groupId === g.id ? 'ring-1' : 'bg-surface-100 text-zinc-400 hover:text-white')}
